            ...
            <div class="card card-profile text-center card-hidden">
              ...
              <div class="card-body ">
                ...
                <div class="form-group">
                  <label for="exampleInput1" class="bmd-label-floating">Enter E-mail</label>
                  <input type="text" class="form-control" id="exampleInput1">
                </div>
              </div>
              <div class="card-footer justify-content-center">
                <button id="lockbtn" class="btn btn-rose btn-round">Submit</button>
              </div>
            </div>
          </div>
        </div>
  ...
  <script>
    $(document).ready(function() {
     ...
     $("#lockbtn").on("click",function(){
      Swal.fire({
                 type: 'success',
                 title: 'Find your password from mail',
